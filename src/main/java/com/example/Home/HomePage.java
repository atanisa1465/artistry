...
public class HomePage extends javax.swing.JPanel {
    ...
    private ArrayList<ImageLayout> imageShowcase = new ArrayList<ImageLayout>();
    ...
    private void initComponents() {
        ...
        GridLayout lay = new GridLayout(0,1,8,4);
        ...
        for (int i = imageShowcase.size()-1; i >= 0; i--) {
           ImageLayout l = imageShowcase.get(i);
            l = imageShowcase.get(i);
            l.setPreferredSize(new Dimension(468, 419));
    ...
    public void addPhotos() {
        ...
        while (cursor.hasNext()) {
            ...
            if ((Boolean)(picAdd.get("posted"))) {
                ...
                Image newimg = ic.getImage().getScaledInstance(450, 336, java.awt.Image.SCALE_SMOOTH);
                ImageIcon setIcon = new ImageIcon(newimg);
                ImageLayout ourImage = new ImageLayout(setIcon, picAdd);
