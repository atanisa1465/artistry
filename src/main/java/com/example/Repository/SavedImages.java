...
import com.example.Home.AllImagesCopy;
import com.example.Home.HomePage;
import com.example.Home.ImageLayout;
...
public class SavedImages extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        while (imageShowcase.size() < 3) {
            imageShowcase.add(new AllImagesCopy());
            falseTrue = true;
        }
    ...
    public boolean hasMe(Document m) {
        ArrayList<String> myList = (ArrayList<String>) m.get("saved");
        for (String s : myList) {
    ...
    public void addPhotos() {
        ...
        while (cursor.hasNext()) {
            ...
            if ((Boolean)(picAdd.get("posted")) && hasMe(picAdd)) {
